...
# User Agent Headers: 
class ScrapeOpsUserAgentMiddleware:
    ...
    def __init__(self, settings):
        self.scrapeops_user_agent_header = settings.get('USER_AGENT_HEADER')
        self.headers_list = []

    def process_request(self, request, spider):
        user_agent_header = self.scrapeops_user_agent_header
...
class ScrapeOpsFakeBrowserHeaderUserAgentMiddleware:
    ...
    @classmethod
    def from_crawler(cls, crawler):
    #    settings = crawler.settings.get('USER_AGENTS', [])
        return cls(crawler.settings)
